...
const Skills: FC = () => {
  ...
  return (
    <Container id="skills" className="bg-dark text-white text-center px-4" fluid>
      <Row xs={1} md={3} className="skills py-6">
          ...
          return (
            <Col key={id} className="skill">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Row xs="auto" className="justify-content-center align-items-center mb-4">
