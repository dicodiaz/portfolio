    ...
    <Col md={6} lg={4} className="project px-md-3">
      ...
      >
        <Card className="bg-dark text-white overflow-hidden">
          ...
          <Card.ImgOverlay>
            <Row className="flex-column justify-content-end h-100">
              <Col xs="auto">
          ...
          <Button className="d-none d-md-inline-block" onClick={() => onSeeProjectClick(data)}>
            See Project
          </Button>
        </Card>
        <Button className="d-md-none w-100" onClick={() => onSeeProjectClick(data)}>
          See Project
        </Button>
      </motion.div>
    </Col>
